...
struct AddItemTypeSection: View {
...
private struct AddItemTypeOptionButton: View {
    let icon: String
    let title: String
    let subtitle: String
    let isSelected: Bool
    ...
    var body: some View {
        Button(action: onSelect) {
            ...
            .overlay(
                RoundedRectangle(cornerRadius: 16)
                    .stroke(
                        isSelected ? DesignTokens.accent : Color.gray.opacity(0.15),
