...
struct IOSAddItemPeriodSection: View {
        ...
        IOSAddItemSectionCard(
            ...
            HStack(spacing: 16) {
                ...
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    IOSAddItemDateField(date: $viewModel.startDate)
                }
                ...
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    if viewModel.endDate != nil {
                        IOSAddItemDateField(date: endDateBinding)
                    } else {
                        Text("Not set")
...
private struct IOSAddItemDateField: View {
